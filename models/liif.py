...
class LIIF(nn.Module):
    ...
    def forward(self, inp, target_shape):
        # TODO: 如果想要让LIIF在当前的训练框架下也能运行的话，需要修改此部分的代码，具体操作如下：
        # 由于现在并没有将coord和cell当作输入，因此需要在forward的过程中，首先将target_width 以及 target_height
        # 传入近来，然后根据target_width 以及 target_height 生成coord和cell，然后再将coord和cell传入到query_rgb中
        # 从而得到最终的输出
